...
<article class="work-basic-layout-body">
	<section class="wall-page">
		<header class="group-header">
			...
			<div class="group-header__body">
				<div class="group-header__info">
					<h2 class="group-header__title">
						<a class="group-header__title-link" href="#">그룹명</a>
					</h2>
					<p class="group-header__short-desc">그룹명 업무 협업방입니다.</p>
					<div class="group-header__meta">
						...
						<span class="group-header__master-nickname">마스터 (마스터명)</span>
						<span class="middle-dot"> · </span>
						<span class="group-header__members-count">?명</span>
					</div>
				</div>
				<div class="group-header__controls">
					...
					<span class="ra-popover__trigger group-header__config-menu-button-wraper" title="">
						<button class="ra-config__button group-header__config-menu-button">
			...
			<div class="group-header__footer ">
				<button class="group-header__desc-button">설명보기</button>
