					...
					<div class="wall-board">
						<div class="board-header">
							...
							<div class="board-header-meta">
								<div class="board-header-meta-id">rkdvnfms5</div>
								<div class="board-header-meta-date">2021-11-20 HH:mm:ss</div>
							</div>
						</div>
							...
							<div class="board-body-attach">
								...
								<ul class="attach-list">
									<li>
										...
										<a class="file-name">1분자기소개.txt (2.28KB)</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="board-footer">
							<span class="msg-button"><span class="text-info">댓글</span><span class="num-count">0</span></span>
							<span class="float-right">
								<button class="link-copy-btn" aria-label="링크 복사">
								...
								<button id="" class="board-setting-btn">
					...
					<div class="wall-comment">
						<div class="comment-header">
							...
							<div class="comment-header-meta">
								<div class="comment-header-meta-id">rkdvnfms5</div>
								<div class="comment-header-meta-date">2021-11-20 HH:mm:ss</div>
							</div>
						</div>
